...
Only the Optical Twin executes today. Manufacturer profiles are research records until OpenLens adapter code and physical verification exist. The compiler therefore labels those profiles **blocked for OpenLens execution**, even when a conceptual companion fallback can be described.

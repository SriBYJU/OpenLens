...
export default function Developers(){
 ...
 return <Page index="06" eyebrow="DEVELOPERS / ADAPTER STARTER" title={<>Build with us.<br/><em>Leave with a real contract.</em></>} lead="For developers connecting a smart-glasses platform. Generate a typed transport boundary, lifecycle tests, verification record, and implementation guide in one portable starter.">
  <FeatureGuide title="Connect hardware without overstating support" intro="OpenLens separates documented device features, executable adapter code, and physical verification. The generated bundle keeps each stage explicit." steps={[

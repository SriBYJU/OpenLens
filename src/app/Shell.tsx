...
const help:Record<Route,{title:string;who:string;steps:string[]}>= {
 ...
 devices:{title:'What is Device Universe?',who:'A sourced comparison and decision workbench for teams deciding which smart-glasses platform fits their requirements.',steps:['Mark capabilities preferred or required in Device Fit.','Open Device Doctor to separate hardware, maker API access, and OpenLens execution.','Compare up to three finalists and follow their evidence.']},
 compiler:{title:'What is the Compiler?',who:'A live planning tool for turning one supported product sentence into an explicit cross-device experience contract.',steps:['Type a translation, description, caption, reminder, identification, assistance, or debugging idea.','Review and correct the detected fields.','Save it to Lens Lab and test it immediately.']},
 benchmarks:{title:'What is Benchmark Lab?',who:'A reproducibility tool for developers comparing repeated simulated runs without hiding failures or inventing unavailable scores.',steps:['Choose how many trials to run.','Inspect raw-to-normalized family scores and any intentionally unscored categories.','Select a raw run, then export JSON for replay or CSV for analysis.']},
 ...
 developers:{title:'What is Build with us?',who:'An executable source SDK, adapter starter, and conformance workbench for developers connecting another hardware platform to OpenLens.',steps:['Run an SDK command against the deterministic twin and inspect its trace.','Name the target, select exposed capabilities, and run the nine conformance checks.','Download the bundle, implement the vendor transport, and physically verify it before claiming support.']},
...
function Footer(){return <footer className="site-footer"><div><a className="brand" href="#/"><Mark/>OPENLENS</a><p>One open optical layer for hardware, experiences, traces, evidence, and measurement.</p></div><div className="footer-nav"><a href="#/lab">Lens Lab</a><a href="#/devices">Devices</a><a href="#/research">Evidence</a><a href="#/methodology">Methodology</a><a href="#/about">About</a></div><div className="footer-meta"><span>v{RELEASE_VERSION} / PUBLIC PREVIEW</span><span>SIMULATION IS NEVER PRESENTED AS HARDWARE MEASUREMENT.</span></div></footer>}

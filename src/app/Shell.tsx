...
const help:Record<Route,{title:string;who:string;steps:string[]}>= {
 ...
 developers:{title:'What is Build with us?',who:'An adapter starter and conformance workbench for developers connecting another hardware platform to OpenLens.',steps:['Name the target and select exposed capabilities.','Run the eight conformance checks, including a deliberate mutation probe.','Download the bundle, implement the vendor transport, and physically verify it before claiming support.']},

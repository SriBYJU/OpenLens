...
export default function SimulationControls(){
 ...
 </div><p>Translation uses authored fixtures in English, Spanish, French, German, and Italian. It is not a general translation model.</p></details><ScenarioCapsulePanel/></>;
}

 ...
 return <main id="main" tabIndex={-1}>
  ...
  <section className="ol-press" aria-labelledby="ol-press-title">
   ...
   <div className="ol-press-grid">
    <a className="ol-press-card" href="https://ghananews.org/shriyan-avadhanula-16-year-old-technology-innovator/" target="_blank" rel="noopener noreferrer" aria-label="Read the Ghana News article about Shriyan Avadhanula"><span className="ol-press-logo"><img src={`${import.meta.env.BASE_URL}assets/press/ghana-news.jpeg`} width="2048" height="2048" alt="Ghana News"/></span><span className="ol-press-copy"><strong>Ghana News</strong><span>Read the article <b aria-hidden="true">↗</b></span></span></a>
    <a className="ol-press-card" href="https://ghanamedia.net/shriyan-avadhanula-16-year-old-innovator-platforms/" target="_blank" rel="noopener noreferrer" aria-label="Read the Ghana Media article about Shriyan Avadhanula"><span className="ol-press-logo"><img src={`${import.meta.env.BASE_URL}assets/press/ghana-media.jpeg`} width="2048" height="2048" alt="Ghana Media"/></span><span className="ol-press-copy"><strong>Ghana Media</strong><span>Read the article <b aria-hidden="true">↗</b></span></span></a>
   </div>
  </section>
